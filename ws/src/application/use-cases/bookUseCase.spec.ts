...
const mockBook = {
  ...
  quantity: 10,
  gender: "Fiction",
  isAvailable: true, // Adicionando a propriedade isAvailable
  reduceQuantity: () => {}, // Adicionando a função reduceQuantity (vazia)
  increaseQuantity: () => {}, // Adicionando a função increaseQuantity (vazia)
};
